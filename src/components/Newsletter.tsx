...
export const newsIssues = [
  ...
  { slug: "rag-renaissance", title: "The RAG Renaissance", date: "15 Feb 2026", excerpt: "PerchÃƒÂ© il cosine similarity non basta piÃƒÆ’Ã‚Â¹? Intro a Hybrid Search.", category: "Architecture", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=800" },
  ...
  return (
    <section id="newsletter" className="flex flex-col justify-center px-4 sm:px-6 lg:px-10 bg-transparent relative overflow-hidden" style={{ height: "100dvh" }}>
      <div className="max-w-7xl mx-auto w-full relative z-10 pt-16 sm:pt-20">
        ...
        {/* Compact subscribe row ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â mobile only */}
        ...
        {/* Full subscribe CTA ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â sm+ only */}
